---
date: 2026-06-24
title: Dashboard package at packages/lore-dashboard in the lore repo
...
## Summary
Reversed the separate-repo call. The dashboard package lives inside the lore repo at
packages/lore-dashboard/, mirroring plugins/ with a packages/ kind-directory.

## Decisions / outcomes
- Package home: packages/lore-dashboard/, self-contained, published from the
...
- CI is path-filtered: validate-plugins.yml on plugins/**, a new dashboard.yml on
  packages/**.
- Example lore/ fixtures inside the package act as a contract drift tripwire.
...
- Flat lore-dashboard/ at the repo root. Rejected: packages/ mirrors plugins/ and
