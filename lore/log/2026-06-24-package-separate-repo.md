...
## Summary
Initial call was to give the dashboard its own repo, DustinVK/lore-dashboard,
...
## Why
The lore repo is a plugin marketplace with its own validation CI and manifest shape;
