...
## Summary
Settled how the dashboard parses lore frontmatter and how it renders each status,
...
skills do not write, so it failed the build on the first real lore. Reading source
