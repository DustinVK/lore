...
This directory is the project's lore: a queryable record of what was decided, why,
and what is still open, captured by the lore plugin and committed next to the code.
...
- 2026-06-24 | 2026-06-24-package-in-repo | Dashboard package at packages/lore-dashboard in the lore repo | areas: repo-structure | topics: publishing, ci | stories: none | active
