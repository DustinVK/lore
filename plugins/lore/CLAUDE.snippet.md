<!--
Setup snippet for the lore plugin.
...
This repo keeps a decision lore in `lore/`, managed by the lore plugin. When a
...
this to the lore?" and, if yes, use the `capture` skill. Only log actual
